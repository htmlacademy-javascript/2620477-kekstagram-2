...
const generatePhotoId = getUniqueNumber(DESC_MIN, DESC_MAX);
const generateUrlId = getUniqueNumber(DESC_MIN, DESC_MAX);

const createPostId = () => generatePhotoId();
const createUrlStr = () => `photos/${generateUrlId()}.jpg`;
